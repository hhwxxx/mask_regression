...
class Polygon(object):
    """Class for polygon.
    """
    def __init__(self, polygon=None, image_shape=(224, 224, 3)):
        """Constructor.

        Args:
            polygon: an integer list representing a polygon or an emtpy list.
    ...
    def get(self):
        """Convenience function for accessing corner points of polygon.
    ...
    def update(self):
        """Update the attribute `_polygon` in place.
        """
        self._polygon = self.create_polygon()

    def reset(self):
        """Reset attribute `_polygon`.
        """
        self._polygon = []
    ...
    def is_overlap(self, polygon):
        """Check whether two polygons overlap with each other.

        Args:
            polygon: an instance of polygon.

        Returns:
            is_overlap: Boolean indicates whether two polygons
                are overlapped.

        Raises:
            TypeError: Type of argument polygon is not polygon.
