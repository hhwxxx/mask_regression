...
SAVE_DIRS = ['./mask_data/quadrilateral_3/train', 
             './mask_data/quadrilateral_3/val',
             './mask_data/quadrilateral_3/test']
CSV_FILES = ['./mask_data/quadrilateral_3/train.csv',
             './mask_data/quadrilateral_3/val.csv',
             './mask_data/quadrilateral_3/test.csv']
...
def create_quadrilateral_mask_noise():
    ...
    for save_dir, csv_file, NUM_IMAGE in zip(SAVE_DIRS, CSV_FILES, NUM_IMAGES):
        ...
        while True:
            ...
            image = image.resize((resize_width, resize_height), Image.NEAREST).resize(IMAGE_SHAPE[:2], Image.NEAREST)
...
def create_quadrilateral_multiple_mask_noise():
    ...
    def _is_overlap(quadrilateral1, quadrilateral2):
        mask1 = _mask(quadrilateral1)
        mask2 = _mask(quadrilateral2)
                ...
                while cur_iter_num < max_iter_num:
                    ...
                    if flag:
                        ...
                        while inner_cur_iter_num < inner_max_iter_num:
                            quadrilateral_3 = _create_quadrilateral()
                            inner_flag = (_is_overlap(quadrilateral_3, quadrilateral_1)
                                          or _is_overlap(quadrilateral_3, quadrilateral_2))
